...
public class ModBlocks {
    ...
    public static final Block BLOCK_OF_PIZZA = new Block(FabricBlockSettings.create().notSolid().strength(1.0f).mapColor(MapColor.BLACK).sounds(BlockSoundGroup.GRAVEL));
